    ...
    return (
        <div className=" fixed top-0 min-h-screen w-[400px] hidden lg:block z-10  bg-[url('images/green-plan-web.svg')] bg-cover bg-no-repeat">
            <div className='flex justify-center p-10'>
                <div>
                    <div>
                        <span> <p className='text-sm text-[#006140] font-bold'>REGISTRO / <span className='text-white'>Candidato</span> </p></span>
                    </div>
                ...
                <div className='flex justify-center absolute bottom-0'>
                    <img className='w-[200px]' src="images/black-man-standup-web.svg" alt="" />
                </div>
            </div>
